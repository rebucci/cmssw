...
void RecoExtractor::beginRun(Run const& run, EventSetup const& setup) 
{
  ...
  {    
    // If you start from an extracted file, the number of events you want to loop on is defined as an option, not in CMSSW... 
...
// -----------------------------------------------------------------------------------------------------------
// Fill the rootuple with info coming from the RECO file
...
// -----------------------------------------------------------------------------------------------------------
// Retrieve the info from an existing extracted ROOTuple 
...
// -----------------------------------------------------------------------------------------------------------
// Initializations when starting from scratch (need to create the extracted stuff)
...
// -----------------------------------------------------------------------------------------------------------
// Initializations when starting from already extracted stuff
...
// -----------------------------------------------------------------------------------------------------------
// Define all things which are post event extraction
